...
// Import extractors
const { DefaultExtractor } = require('@discord-player/extractor');
...
player.extractors.register(DefaultExtractor, {});
console.log('[Player] Registered DefaultExtractor for music sources');
